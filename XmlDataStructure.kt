...
fun main() {
    ...
    val a1=Entity("filter1",null)
    a1.addAttribute(att1)
    a1.addAttribute(att2)
    val t1=TextEntity("1film","mission impossible",a1)
    val t2=TextEntity("2film","joker",a1)
    val a2=Entity("filter2",a1)
    a2.addAttribute(att2)
    val t3=TextEntity("1film","mission impossible",a2)
    val a3=Entity("select",a1)


    val d=XMLDocument("file1",a1)
    //d.printDocument()
    print(d.findEntity("1film")?.name)//fix output
